...
export const App: React.FC = () => {
  ...
  async function sendTransaction(account: AccountData) {
    ...
    // Add a transfer transaction to send 1 token to the specified address
    const recipientAddress =
      "0xff73c418feaac3ebfc2631f43c04557cc35369cc69e58ddd8f446c65bf5b4cd3";
  ...
  return (
    <div id="page">
      ...
      <div id="logos">
        ...
        <LinkExternal
          href="https://github.com/juzybits/polymedia-zklogin-demo"
          follow={true}
        >
          <GitHubLogo />
        </LinkExternal>
      ...
      <h2 className="test-theo">Version 2</h2>
